...
export default function AgregarDoctorBtn() {
  ...
  const onSubmit = async () => {
    ...
    _catalogo.categorias.push(docData);
  ...
  return (
    <>
      <Button onClick={handleOpen}>Agregar nueva categoria</Button>
      <Drawer isOpen={isOpen} placement="right" onClose={onClose} size={'md'}>
        <DrawerOverlay />
        <DrawerContent>
          <DrawerCloseButton />
          <DrawerHeader borderBottomWidth="1px">
            Agregar nueva categoria de estudio
          </DrawerHeader>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <Stack spacing="24px">
                <FormControl isInvalid={errors.titulo}>
                  ...
                  <Input
                    placeholder="Nombre de categoria de estudios"
                    {...register('titulo', {
